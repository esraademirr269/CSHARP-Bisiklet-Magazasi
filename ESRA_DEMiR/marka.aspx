<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="marka.aspx.cs" Inherits="_151213117_ESRA_DEMiR.marka" %>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="active"><a href="marka.aspx"><i class="lnr lnr-book"></i> <span>MARKALAR</span></a></li>              
		...
		<!-- left side end-->
						...
						<div class="signin">
							...
							<div class="log-input">
								<div class="log-input-left">
                                    <asp:TextBox ID="TextBox3" runat="server" value="MARKA ADI" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'MARKA ADI';}"></asp:TextBox>
								   </div>
        	...
        	<div class="sign-in-form">
						...
						<div class="signin">
							...
							<div class="log-input">
								<div class="log-input-left">
                                    <asp:TextBox ID="TextBox1" runat="server" value="MARKA ADI" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'MARKA ADI';}"></asp:TextBox>
								   </div>
    ...
    <SortedDescendingHeaderStyle BackColor="#820000" />
         	...
         	<div class="sign-in-form">
						...
						<div class="signin">
							...
							<div class="log-input">
								<div class="log-input-left">
								    <asp:TextBox ID="TextBox6" runat="server" value="MARKA ADI" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'MARKA ADI';}"></asp:TextBox>
								   </div>
        ...
        <div class="sign-in-form">
						...
						<div class="signin">
                            ...
                            <div class="log-input">
								<div class="log-input-left">
								    <asp:TextBox ID="TextBox4" runat="server" value=" DÜZENLENECEK MARKA ADI" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'DÜZENLENECEK MARKA ADI';}"></asp:TextBox>
								   </div>
								<span class="checkbox2">
									 <label class="checkbox"><input type="checkbox" name="checkbox" checked=""></label>
								</span>
