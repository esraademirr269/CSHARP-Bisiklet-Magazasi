<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kategori.aspx.cs" Inherits="_151213117_ESRA_DEMiR.kategori" %>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="active"><a href="kategori.aspx"><i class="lnr lnr-book"></i> <span>KATEGORİ</span></a></li>
		...
		<!-- left side end-->
						...
						<div class="signin">
							...
							<div class="log-input">
								<div class="log-input-left">
                                    <asp:TextBox ID="TextBox3" runat="server" value="KATEGORİ ADI" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'KATEGORİ ADI';}"></asp:TextBox>
								   </div>
        	...
        	<div class="sign-in-form">
						...
						<div class="signin">
							...
							<div class="log-input">
								<div class="log-input-left">
                                    <asp:TextBox ID="TextBox1" runat="server" value="KATEGORİ ADI" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'KATEGORİ ADI';}"></asp:TextBox>
								   </div>
         	...
         	<div class="sign-in-form">
            	...
            	<div class="sign-in-form">
						...
						<div class="signin">
							...
							<div class="log-input">
								<div class="log-input-left">
								    <asp:TextBox ID="TextBox2" runat="server" value="KATEGORİ ADI" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'KATEGORİ ADI';}"></asp:TextBox>
								   </div>
								<span class="checkbox2">
									 <label class="checkbox"><input type="checkbox" name="checkbox" checked=""></label>
								</span>
								<div class="clearfix"> </div>
                            		...
                            		<div class="log-input">
								<div class="log-input-left">
								    <asp:TextBox ID="TextBox4" runat="server" value="DÜZENLENECEK KATEGORİ ADI" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = ' DÜZENLENECEK KATEGORİ ADI';}"></asp:TextBox>
								   </div>
								<span class="checkbox2">
									 <label class="checkbox"><input type="checkbox" name="checkbox" checked=""></label>
								</span>
                                ...
                                <asp:Button ID="Button4" runat="server" Text="DÜZENLE" OnClick="Button4_Click"    />
